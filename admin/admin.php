...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <a href="admin.php" class="navbar-brand abs"><img src="../assets/logo1.png" height="30" width="30"> PresentO</a>
...
<div class="col">
  ...
  <?php
//connect to db
$conn = new mysqli("localhost","root","abhay@mysql","attendance_marking");
// Check connection
